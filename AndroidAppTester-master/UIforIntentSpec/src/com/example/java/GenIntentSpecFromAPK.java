...
public class GenIntentSpecFromAPK {
	...
	private static boolean PRINT_PKG_NAME;
			...
			while (parserEvent != XmlPullParser.END_DOCUMENT) {
				...
				case XmlPullParser.START_TAG:
					...
					if ("manifest".equals(name)) {
						...
						if (PRINT_PKG_NAME) {
							FileWriter fw = new FileWriter(pkgname_file);
							fw.write(manifest);
							fw.flush();
							fw.close();
						}
...
//		}
	...
	/*
	 * $ java GenIntentSpecFromAPK [-PRINT_PKG_NAME XXX.pkgname ] android_apk_file
	 */
	private static String pkgname_file;
	public static void main(String[] args) {

		requestType = Type.All;
		String apkfile;
		
		PRINT_PKG_NAME = false;
		pkgname_file = "";
		if (args.length >= 2 && "-PRINT_PKG_NAME".equals(args[0])) {
			pkgname_file = args[1];
